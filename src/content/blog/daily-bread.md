...
Growing up in Scotland, our family discovered [Robert Murray M’Cheyne’s Bible reading plan](/mccheyne) and followed it faithfully for years.
...
I’ve always loved technology too. Building [my first iOS app](/sunday)—a simple calendar clock—was gruelling but exhilarating. That experience opened the door to something deeper: the app I’d always wanted.
...
The need grew so strong I built [a basic web version first](/bible-app). Python and Streamlit made it quick. Every day it loaded the readings with optional text-to-speech. I used it faithfully.
